...
import com.magora.realmpaginator.BuildConfig;
...
/**
 * A helper class for {@link RealmPagedList.BoundaryCallback BoundaryCallback}s and
 * {@link RealmDataSource}s to help with tracking network requests.
 * <p>
...
public class PagingRequestHelper {
    ...
    @AnyThread
    public void recordResult(@NonNull RequestWrapper wrapper, @Nullable Throwable throwable) {
        StatusReport report = null;
    ...
    public static class RequestWrapper implements Runnable {
        ...
        public RequestWrapper(@NonNull Request request, @NonNull PagingRequestHelper helper,
    ...
    public enum RequestType {
        /**
         * Corresponds to an initial request made to a {@link RealmDataSource} or the empty state for
         * a {@link RealmPagedList.BoundaryCallback BoundaryCallback}.
         */
        INITIAL,
        /**
         * Corresponds to the {@code loadBefore} calls in {@link RealmDataSource} or
         * {@code onItemAtFrontLoaded} in
         * {@link RealmPagedList.BoundaryCallback BoundaryCallback}.
         */
        BEFORE,
        /**
         * Corresponds to the {@code loadAfter} calls in {@link RealmDataSource} or
